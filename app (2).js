...
async function startMatch() {
  ...
  // Ensure we have a valid price before starting (especially for crypto pairs)
  let price = getGamePrice();
  if (!price || price === 0) {
    try {
      // Temporarily set currentPair to game pair for fetchTicker
...
// === SOCIAL SHARING ===
const SHARE_URL = 'https://incentivesteam.github.io/incentives-game/';
const SHARE_GITHUB_URL = 'https://github.com/incentivesteam/incentives-game';
