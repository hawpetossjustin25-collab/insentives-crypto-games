...
.gp-deploy-cards{display:flex;flex-direction:column;gap:10px;margin-bottom:12px}
.gp-deploy-card{
  background:var(--bg3);border:1px solid var(--border);border-radius:10px;
  padding:12px;transition:all .2s;position:relative;
}
.gp-deploy-card[data-deployed="true"]{border-color:var(--green);background:rgba(0,200,83,.05)}
.gp-deploy-card-header{display:flex;align-items:center;gap:8px;margin-bottom:8px}
.gp-deploy-icon{font-size:18px}
.gp-deploy-info{flex:1}
.gp-deploy-name{font-size:12px;font-weight:700;color:var(--text)}
.gp-deploy-record{font-size:10px;color:var(--muted)}
.gp-deploy-cost{
  font-size:11px;font-weight:700;color:var(--accent);
  background:rgba(91,110,234,.1);padding:4px 8px;border-radius:8px;
}
.gp-deploy-options{margin-bottom:10px}
.gp-deploy-options label{display:block;font-size:10px;color:var(--muted);margin-bottom:4px}
.gp-deploy-amount{
  width:100%;padding:6px 8px;background:var(--bg);border:1px solid var(--border);
  color:var(--text);border-radius:6px;font-size:11px;
}
.gp-deploy-btn{
...
.gp-deploy-status{
  font-size:10px;font-weight:600;color:var(--muted);text-align:center;margin-top:8px;
}
